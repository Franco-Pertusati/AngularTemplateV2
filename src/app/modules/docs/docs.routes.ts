...
import { ToggleVisibilityDocComponent } from "./pages/toggle-visibility-doc/toggle-visibility-doc.component";
...
export const docsRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'toggle-visibility', component: ToggleVisibilityDocComponent },
